...
-- Проверка, пуста ли таблица Publications
IF NOT EXISTS (SELECT * FROM [dbo].[Publications])
BEGIN
    -- Заполнение таблицы Publications случайными данными
